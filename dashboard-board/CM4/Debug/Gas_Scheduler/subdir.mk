...
C_SRCS += \
../Gas_Scheduler/gas_scheduler.c 

OBJS += \
./Gas_Scheduler/gas_scheduler.o 

C_DEPS += \
./Gas_Scheduler/gas_scheduler.d 


# Each subdirectory must supply rules for building sources it contributes
Gas_Scheduler/%.o Gas_Scheduler/%.su Gas_Scheduler/%.cyclo: ../Gas_Scheduler/%.c Gas_Scheduler/subdir.mk
...
clean: clean-Gas_Scheduler

clean-Gas_Scheduler:
	-$(RM) ./Gas_Scheduler/gas_scheduler.cyclo ./Gas_Scheduler/gas_scheduler.d ./Gas_Scheduler/gas_scheduler.o ./Gas_Scheduler/gas_scheduler.su

.PHONY: clean-Gas_Scheduler
